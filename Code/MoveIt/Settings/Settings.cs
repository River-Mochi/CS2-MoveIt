...
namespace MoveIt.Settings
{
    ...
    [SettingsUIMouseAction(QInputSystem.MOUSE_APPLY, ActionType.Button, rebindOptions: RebindOptions.None, ModifierOptions.Ignore, false, false, new string[] { "MoveIt_Input" })]
    [SettingsUIMouseAction(QInputSystem.MOUSE_CANCEL, ActionType.Button, rebindOptions: RebindOptions.None, ModifierOptions.Ignore, false, false, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardAction(Inputs.KEY_MOVEDOWN, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Ignore, false, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardAction(Inputs.KEY_MOVEUP, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Ignore, false, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardAction(Inputs.KEY_MOVEDOWN2, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Ignore, false, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardAction(Inputs.KEY_MOVEUP2, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Ignore, false, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardAction(Inputs.KEY_UNDO, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Allow, true, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardAction(Inputs.KEY_REDO, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Allow, true, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardAction(Inputs.KEY_DESELECTALL, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Allow, true, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardAction(Inputs.KEY_DEBUGFREEZE, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Allow, true, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardAction(Inputs.KEY_TOGGLEMARQUEE, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Allow, true, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardAction(Inputs.KEY_TOGGLEMANIP, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Allow, true, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardAction(Inputs.KEY_FILTERSTOGGLE, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Allow, true, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardAction(Inputs.KEY_TB_TERRAINHEIGHT, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Allow, true, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardAction(Inputs.KEY_TB_OBJECTHEIGHT, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Allow, true, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardAction(Inputs.KEY_TB_OBJANGLEINDIV, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Allow, true, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardAction(Inputs.KEY_TB_OBJANGLEGROUP, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Allow, true, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
